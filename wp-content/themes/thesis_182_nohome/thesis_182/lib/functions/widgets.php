...
?>
					<li class="widget">
						<div class="widget_box">
							...
							<p class="remove_bottom_margin">This is Sidebar <?php print $sidebar;?>. You can edit the content that appears here by visiting your <a href="%2$s">Widgets panel</a> and modifying the <em>current widgets</em> in Sidebar %1$d. Or, if you want to be a true ninja, you can add your own content to this sidebar by using the appropriate hooks</p>
						</div>
					</li>
<?php
	}
