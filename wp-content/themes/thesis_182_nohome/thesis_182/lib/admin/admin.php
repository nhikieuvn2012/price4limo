...
function thesis_options_nav($depth = 1) {
	...
	echo "$indent\t<li><a href=\"http://anonym.to/?http://diythemes.com/thesis/\" title=\"" . __('Thesis news plus tutorials and advice from Thesis pros!', 'thesis') . "\">" . __('Thesis Blog', 'thesis') . "</a></li>\n";
	echo "$indent\t<li><a href=\"http://anonym.to/?http://diythemes.com/thesis/rtfm/\" title=\"" . __('Documentation, tutorials, and how-tos that will help you get the most out of Thesis', 'thesis') . "\">" . __('User&#8217;s Guide', 'thesis') . "</a></li>\n";
	echo "$indent\t<li><a href=\"http://anonym.to/?http://diythemes.com/forums/\" title=\"" . __('Stuck? Don&#8217;t worry&#8212;you can find expert help in our support forums.', 'thesis') . "\">" . __('Support Forums', 'thesis') . "</a></li>\n";
	echo "$indent\t<li><a href=\"http://anonym.to/?http://diythemes.com/affiliate-program/\" title=\"" . __('Join the Thesis Affiliate Program and earn money selling Thesis!', 'thesis') ."\">" . __('Affiliate Program', 'thesis') . "</a></li>\n";
	echo "$indent</ul>\n";
}
...
//	var $feed = 'http://anonym.to/?http://diythemes.com/thesis/feed/';
