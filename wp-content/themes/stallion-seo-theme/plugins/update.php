...
class ThemeUpdateChecker {
	public $theme = 'stallion-seo-theme';              //The theme associated with this update checker instance.
	public $metadataUrl = 'http://www.stallion-theme.com/updates/themes/stallion-seo-theme/info.json';        //The URL of the theme's metadata file.
	 ...
	 * Class constructor.
	 *
	 * @param string $theme Theme slug, e.g. 'twentyeleven'.  
