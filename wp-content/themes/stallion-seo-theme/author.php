...
<h1 class="archives">Articles by <?php wp_title(); ?></h1>
</div>
</div>

<?php while(have_posts()) : the_post(); ?>

<?php if ($wp_query->current_post == 0) : ?><div id="post-author" class="post-meta <?php /* semantic_entries(); */ ?>" style="padding-top:10px;"><div class="post-content"><?php include(get_template_directory()."/layout/author-bio2.php"); ?></div></div><?php endif; ?>
