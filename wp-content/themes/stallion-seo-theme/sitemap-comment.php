<?php
/*
Template Name: Sitemap with Recent Comments, Pages and Posts
*/
?>
<?php get_header(); ?>
<div id="content_all">
...
<p>Most Recent 100 Comments on the <?php bloginfo('name'); ?> website</p>

<?php mw_recent_comments(100, false, 100, 20, 40, 'comment_only', '<p><strong>Comment %comid% by %author_name%</strong> on %date% :<br /><a href="%permalink%">%title%</a></p>','d.m.y, H:i'); ?>

</div>

<div class="divpadding"></div>

<h2><?php bloginfo('name'); ?> Sitemap</h2>
