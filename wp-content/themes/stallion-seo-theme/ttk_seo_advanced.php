<?php
if (!function_exists('ttk_seo_advanced')) {
function ttk_seo_advanced($theme='',$array='',$file='') {
global ${$theme};
if ($theme == '' or $array == '' or $file == '') {
die ('No theme name, theme option, or parent defined in Theme Toolkit');
}
${$theme} = new ttk_seo_advanced($theme,$array,$file);
}
}
?>
...
<?php
if (!class_exists('ttk_seo_advanced')) {
class ttk_seo_advanced{
var $option, $infos;
function ttk_seo_advanced($theme,$array,$file){
global $wp_version;
...
add_submenu_page('ttk_functions.php', __('Stallion SEO Theme SEO Advanced','stallion-menu'), __('SEO Advanced','stallion-menu'), 'manage_options', 'ttk_seo_advanced_functions.php', array(&$this,'admin_menu'));
}
function do_init() {
$themes = get_themes();
...
$options = get_option('theme-'.$this->infos['theme_shortname'].'-seo-advanced');
...
update_option('theme-'.$this->infos['theme_shortname'].'-seo-advanced','');
if (update_option('theme-'.$this->infos['theme_shortname'].'-seo-advanced',$array)) {
...
echo '<meta http-equiv="refresh" content="0;URL=admin.php?page=ttk_seo_advanced_functions.php">';
echo "<script> self.location(\"admin.php?page=ttk_seo_advanced_functions.php\");</script>";
if ($this->infos['active']) {
...
global $wpdb;
$where = 'theme-'.$this->infos['theme_shortname'].'-seo-advanced';
...
add_option('theme-'.$this->infos['theme_shortname'].'-seo-advanced',$options, 'Options for theme '.$this->infos['theme_name']);
...
echo "<style type='text/css'>input[type=text] { width: 200px;}</style><h2>Configure Stallion SEO Theme : SEO Advanced Options</h2>";
...
<?php echo base64_decode('');}else{echo base64_decode('PHAgY2xhc3M9InN1Ym1pdCI+PGlucHV0IHR5cGU9InN1Ym1pdCIgY2xhc3M9ImJ1dHRvbi1wcmltYXJ5IiB2YWx1ZT0iU2F2ZSBTZXR0aW5ncyIgLz48L3A+PC9mb3JtPg==');}global $st_op_advanced_seo;if($st_op_advanced_seo->option[base64_decode('c3Rfc2VvX3BsdWdfd2Fybg==')]==base64_decode('MQ==')):if(class_exists(base64_decode('WW9hc3RfV1BTRU9fUGx1Z2luX0FkbWlu'))):include(get_template_directory().base64_decode('L3BsdWdpbnMveW9hc3Qtc2VvLXBsdWdpbi5waHA='));endif;if(class_exists(base64_decode('QWxsX2luX09uZV9TRU9fUGFjaw=='))):$allinone_options=get_option(base64_decode('YWlvc2VvcF9vcHRpb25z'));if($allinone_options[base64_decode('YWlvc3BfZW5hYmxlZA==')]==base64_decode('MQ==')){include(get_template_directory().base64_decode('L3BsdWdpbnMvYWxsLWluLW9uZS1zZW8tcGx1Z2luLnBocA=='));;}endif;endif;echo base64_decode('');echo base64_decode('PGgzPkNyZWRpdHM8L2gzPg==');echo base64_decode('PHA+').$this->infos[base64_decode('dGhlbWVfc2l0ZQ==')].base64_decode('IGJ5IA==').$this->infos[base64_decode('dGhlbWVfYXV0aG9y')].base64_decode('PC9wPg==');echo base64_decode('');echo base64_decode('PC9kaXY+');}}}?>