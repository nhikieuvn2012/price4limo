<?php
/**
 * Audio Post Format on index and archive pages
 *
 * @package WordPress
...
<?php } ?>
<?php /*
<?php if(st_adsense_on()==1 && st_adsense_con1()==0){if (global $AdSense1; $wp_query->current_post == st_adsense_main_ad()){_e('<div class="' . st_adsense_float() . '">'); st_adsense_insert($AdSense1);?>
</div><?php }} ?>
