...
define('THESIS_CUSTOM', STYLESHEETPATH . '/custom' . thesis_multisite_support());
...
if (file_exists(THESIS_CUSTOM)) {
	define('THESIS_CUSTOM_FOLDER', get_bloginfo('stylesheet_directory') . '/custom' . thesis_multisite_support()); #wp
...
function thesis_multisite_support() {
